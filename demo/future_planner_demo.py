...
SAVE_PATH = os.path.join(PROJECT_ROOT, "future_safe_path.png")
...
for frame_name in frames:
    ...
    for trk in tracks:
        ...
        radius = int(60 + 120*collision_prob)
    ...
    if not saved and len(tracks)>=5:
        ...
        print("Saved planner output:",SAVE_PATH)

        saved=True


    cv2.imshow("Future Collision Planner",frame)
